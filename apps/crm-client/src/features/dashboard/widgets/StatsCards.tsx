    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card className="p-8 flex items-center gap-6 hoverable transform transition-transform hover:-translate-y-1">
                ...
                <div>
                    <p className="text-slate-400 text-xs font-bold uppercase tracking-widest mb-1">Pacientes Activos</p>
            ...
            <Card className="p-8 flex items-center gap-6 hoverable transform transition-transform hover:-translate-y-1">
                ...
                <div>
                    <p className="text-slate-400 text-xs font-bold uppercase tracking-widest mb-1">Fecha Actual</p>
