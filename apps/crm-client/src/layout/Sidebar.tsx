...
export const Sidebar: React.FC<SidebarProps> = ({ currentView, onNavigate, userEmail, isOpen = false, onClose, events }) => {
            ...
            >
                ...
                <nav className="flex-1 py-6 space-y-2 px-3 overflow-y-auto custom-scrollbar relative z-10">
                    ...
                    >
                        ...
                        />
                        {(!collapsed || isOpen) && (
                            <span className={`font-medium text-sm tracking-wide ${currentView === 'dashboard' ? 'font-bold text-slate-900' : 'text-slate-600'} md:${collapsed ? 'hidden' : 'block'}`}>
                                Panel Principal
                            </span>
                        )}
                    </button>
                    ...
                    <div className="pt-4 pb-2">
                        {(!collapsed || isOpen) && <p className="px-4 text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2 md:block hidden">Pacientes</p>}
                        {[
                    ...
                    <div className="pt-2 pb-2">
                        {(!collapsed || isOpen) && <p className="px-4 text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2 md:block hidden">Gestión</p>}
                        <button
                        ...
                        >
                            <Sparkles size={18} className={currentView === 'sessions' ? 'text-pink-500' : 'text-slate-400'} />
                        ...
                        >
                            <Users size={18} className={currentView === 'group-sessions' ? 'text-pink-500' : 'text-slate-400'} />
                        ...
                        >
                            <Calendar size={18} className={currentView === 'calendar' ? 'text-pink-500' : 'text-slate-400'} />
                    ...
                    {/* SECTION: TOOLS */}
                    <div className="pt-2 pb-2">
                        {(!collapsed || isOpen) && <p className="px-4 text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2 md:block hidden">Herramientas</p>}
                        <button
                        ...
                        >
                            <FileText size={18} className={currentView === 'resources' ? 'text-pink-500' : 'text-slate-400'} />
                        ...
                        >
                            <Settings size={18} className={currentView === 'settings' ? 'text-pink-500' : 'text-slate-400'} />
