...
import {
    X, Music, LayoutDashboard, Users, User, Users2, FileText, Settings,
    ChevronLeft, ChevronRight, Smile, Baby
} from 'lucide-react';
...
export const Sidebar = ({ view, setView, filter, setFilter, events = [], isOpen, toggle }: SidebarProps) => {
