...
import { CLINICAL_GUIDES, SESSION_ACTIVITIES, EVALUATION_AREAS } from '../../lib/constants';
...
export const SessionModal = ({ onClose, onSave, initialData, patientType = 'other' }: SessionModalProps) => {
